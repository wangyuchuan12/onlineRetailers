...
<tiles:putAttribute name="body">
							...
							<a class="group">
								<div class="group_header">
									...
									<div class="group_good_info">
										...
										<div class="group_good_chat" onclick="javascript:skipToChat('${group.adminId}','3','','','${group.group_id}','${token.id}')">
    ...
    <script type="text/javascript">
    		$(document).ready(function(){
    			...
    			wx.ready(function(){
    				wxOnMenuShareAppMessage("${typeName}","${typeTitle}","http://${domainName}"+"/main/good_list?good_type=${goodType}","${typeImg}","link");
    				wx.hideMenuItems({
