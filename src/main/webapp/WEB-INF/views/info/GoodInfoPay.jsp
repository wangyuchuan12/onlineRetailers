        ...
        <div class="good_info_pay">
        	...
        	<div class="good_info_pay_type">
	        	...
	        	<div class="good_info_pay_button">
	        		<a href="javascript:onChooseWXPay('${appId}','${package}','${nonceStr}','${paySign}','${signType}','${timestamp}','${payGoodInfo.good_id}','${payGoodInfo.pay_type}','${payGoodInfo.pay_type}','${token.id}');">立即支付</a>
	        	</div>
